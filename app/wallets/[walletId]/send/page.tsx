      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Send Funds</h1>
            <p className="text-gray-600 mb-8">Choose how you want to send funds</p>

            <div className="space-y-3">
              <button
                onClick={() => window.location.href = `/wallets/${walletId}/send-ln`}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-bold">Send on Lightning</p>
              ...
              <button
                onClick={() => window.location.href = `/wallets/${walletId}/send-spark`}
                className="flex items-center justify-between w-full bg-orange-50 text-bitcoin p-4 rounded-xl hover:bg-orange-100 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white rounded-lg">
                  ...
                  <div className="text-left">
                    <p className="font-bold">Send on Spark</p>
                    <p className="text-sm text-gray-600">Send to another Spark wallet</p>
                  </div>
                </div>
                <FaArrowRight className="h-4 w-4 text-gray-400 group-hover:text-bitcoin transition-colors" />
              </button>
              ...
              <button
                onClick={() => window.location.href = `/wallets/${walletId}/send-btc`}
                className="flex items-center justify-between w-full bg-orange-50 text-bitcoin p-4 rounded-xl hover:bg-orange-100 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white rounded-lg">
                  ...
                  <div className="text-left">
                    <p className="font-bold">Send on Bitcoin</p>
                    <p className="text-sm text-gray-600">Send to a Bitcoin address</p>
                  </div>
                </div>
                <FaArrowRight className="h-4 w-4 text-gray-400 group-hover:text-bitcoin transition-colors" />
              </button>
